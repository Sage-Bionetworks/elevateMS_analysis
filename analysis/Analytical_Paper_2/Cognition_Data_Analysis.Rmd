...
blockSummary <- synTableQuery("select * from syn11309239")
blockSummary <- blockSummary@values 
blockSummary <- merge(blockSummary, healthCode_to_externalID, all=T) %>% 
  dplyr::mutate(logDurationSecs = log10(durationMS/1000))
```
```{r, eval=F}
