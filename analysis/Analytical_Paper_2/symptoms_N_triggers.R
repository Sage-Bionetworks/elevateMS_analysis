...
install_load(c('tidyverse', 'lubridate', 'ggpubr', 'synapser'))
install_load("plotly", "tableone", "ggthemes")
...
ggsave(file = "~/dev/elevateMS_analysis/analysis/engagement_Paper_1/FINAL_FIGS/symptoms.png",
       plot=p,  height = 10, width = 6, dpi = 300)

install_load("wordcloud")
set.seed(1234)
png("~/dev/elevateMS_analysis/analysis/engagement_Paper_1/FINAL_FIGS/symptomsWordCloud.png", 
    height = 6, width = 6, res = 150, units="in" )
...
n_distinct(triggers$healthCode)
#### What percentage of people report each symptom?
...
p <- ggdotchart(trigger_summary, x = "trigger", y = "percent",
                ...
                y.text.col = TRUE,                           
                ggtheme = theme_pubr() ) + theme_cleveland() 
ggsave(file = "~/dev/elevateMS_analysis/analysis/engagement_Paper_1/FINAL_FIGS/triggers.png",
       plot=p,  height = 10, width = 6, dpi = 300)

png("~/dev/elevateMS_analysis/analysis/engagement_Paper_1/FINAL_FIGS/triggersWordCloud.png", 
    height = 4, width = 4, res = 150, units="in" )
