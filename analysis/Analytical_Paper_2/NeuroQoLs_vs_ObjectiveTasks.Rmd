...
df <- df$data[[1]]
p <- ggplot(data=df, aes(x=class, y=log10(value))) + geom_boxplot(width=0.5) + geom_jitter(size=0.3, width=0.2, color="grey60") + theme_bw() + xlab('Cognition') + ylab('log10(time sd)') + theme_bw(base_size = 15)
p
