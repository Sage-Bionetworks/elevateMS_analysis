...
p <- ggplot(data=df, aes(x=class, y=log10(value))) + geom_boxplot(width=0.7) + geom_jitter(size=0.3, width=0.3, color="grey60") + theme_bw() + xlab('Cognition') + ylab('log10(max tap interval)') + theme_bw(base_size = 15) 
p
ggsave("Figs_N_Tables/NeuroQoL_vs_TapF1.jpeg", plot = p, width = 5, height = 5, dpi = 150)
ggsave("Figs_N_Tables/NeuroQoL_vs_TapF1.tiff", plot = p, width = 5, height = 5, dpi = 150)

 
df  <- tapF_association %>% filter(feature == 'maxTapInter', survey == 'neuroQOL Upper Extremity')
df <- df$data[[1]]
p <- ggplot(data=df, aes(x=class, y=log10(value))) + geom_boxplot(width=0.9) + geom_jitter(size=0.3, width=0.3, color="grey60") + theme_bw() + xlab('Upper Extremity') + ylab('log10(max tap interval)') + theme_bw(base_size = 15) 
p
ggsave("Figs_N_Tables/NeuroQoL_vs_TapF2.jpeg", plot = p, width = 5, height = 5, dpi = 150)
ggsave("Figs_N_Tables/NeuroQoL_vs_TapF2.tiff", plot = p, width = 5, height = 5, dpi = 150)


# tapF.mat <- tapF_association %>% select(feature, survey, lmm.anova.pval) %>%
#   tidyr::spread(survey, lmm.anova.pval) %>%
#   tibble::column_to_rownames('feature')
# 
# cols <- c('#c51b7d', '#e0e0e0', '#e0e0e0')
# heatmap.tapF <- ComplexHeatmap::Heatmap(tapF.mat, 
#                                         show_row_names = T, row_title_gp = gpar(fontsize=10),
#                                         cluster_columns = F,
#                                         name='FDR', cluster_rows = T,
#                                         clustering_method_rows = "average",
#                                         column_title = "Session 1 vs 3",
#                                         na_col = "gray",
#                                         col  = circlize::colorRamp2(breaks = c(0,0.05,1), cols))
# heatmap.tapF
```
...
df <- df$data[[1]]
df <- df %>% filter(class != 'Severe') #Removing as there is very low data - sensitivity analysis shows removing this wont impact the trend and stats sig

p <- ggplot(data=df, aes(x=class, y=log10(value))) + geom_boxplot(width=0.7) + geom_jitter(size=0.3, width=0.3, color="grey60") + theme_bw() + xlab('Lower Extremity') + ylab('log10(accelerometer- P0Y*)') + theme_bw(base_size = 15)
p
ggsave("Figs_N_Tables/NeuroQoL_vs_WalkF1.jpeg", plot = p, width = 5, height = 5, dpi = 150)
ggsave("Figs_N_Tables/NeuroQoL_vs_WalkF1.tiff", plot = p, width = 5, height = 5, dpi = 150)


#### heatmap
# walkF.mat <- walkF_association %>% select(feature, survey, lmm.anova.pval) %>%
#   tidyr::spread(survey, lmm.anova.pval) %>%
#   tibble::column_to_rownames('feature')
# cols <- c('#c51b7d', '#e0e0e0', '#e0e0e0')
# heatmap.walkF <- ComplexHeatmap::Heatmap(walkF.mat, 
#                                         show_row_names = T, row_title_gp = gpar(fontsize=10),
#                                         cluster_columns = F,
#                                         name='FDR', cluster_rows = T,
#                                         clustering_method_rows = "average",
...
df <- df$data[[1]]
p <- ggplot(data=df, aes(x=class, y=log10(value))) + geom_boxplot(width=0.5) + geom_jitter(size=0.3, width=0.2, color="grey60") + theme_bw() + xlab('Cognition') + ylab('log10(total displacement volume)') + theme_bw(base_size = 15)
p
ggsave("Figs_N_Tables/NeuroQoL_vs_RestF1.jpeg", plot = p, width = 5, height = 5, dpi = 150)
ggsave("Figs_N_Tables/NeuroQoL_vs_RestF1.tiff", plot = p, width = 5, height = 5, dpi = 150)
...
p
ggsave("Figs_N_Tables/NeuroQoL_vs_RestF2.jpeg", plot = p, width = 6, height = 5, dpi = 150)
ggsave("Figs_N_Tables/NeuroQoL_vs_RestF2.tiff", plot = p, width = 6, height = 5, dpi = 150)
...
p
ggsave("Figs_N_Tables/NeuroQoL_vs_RestF3.jpeg", plot = p, width = 6, height = 5, dpi = 150)
ggsave("Figs_N_Tables/NeuroQoL_vs_RestF3.tiff", plot = p, width = 6, height = 5, dpi = 150)
```
...
df <- df$data[[1]]
p <- ggplot(data=df, aes(x=class, y=log10(value))) + geom_boxplot(width=0.5) + geom_jitter(size=0.3, width=0.2, color="grey60") + theme_bw() + xlab('NeuroQoL Cognition') + ylab('log10(time sd)') + theme_bw(base_size = 15)
p
ggsave("Figs_N_Tables/NeuroQoL_vs_DSSTF1.jpeg", plot = p, width = 5, height = 5, dpi = 150)
ggsave("Figs_N_Tables/NeuroQoL_vs_DSSTF1.tiff", plot = p, width = 5, height = 5, dpi = 150)
...
p
ggsave("Figs_N_Tables/NeuroQoL_vs_DSSTF2.jpeg", plot = p, width = 6, height = 5, dpi = 150)
ggsave("Figs_N_Tables/NeuroQoL_vs_DSSTF2.tiff", plot = p, width = 6, height = 5, dpi = 150)


#Neuro-QoL Lower Extremity 
df  <- dsstF_association %>% filter(feature == 'sdTime', survey == 'neuroQOL Lower Extremity')
df <- df$data[[1]]
p <- ggplot(data=df, aes(x=class, y=log10(value))) + geom_boxplot(width=0.5) + geom_jitter(size=0.3, width=0.2, color="grey60") + theme_bw() + xlab('NeuroQoL Lower Extremity') + ylab('log10(average time)') + theme_bw(base_size = 15)
p
ggsave("Figs_N_Tables/NeuroQoL_vs_DSSTF2.jpeg", plot = p, width = 6, height = 5, dpi = 150)
ggsave("Figs_N_Tables/NeuroQoL_vs_DSSTF2.tiff", plot = p, width = 6, height = 5, dpi = 150)
...
df <- df$data[[1]]
p <- ggplot(data=df, aes(x=class, y=log10(value))) + geom_boxplot(width=0.5) + geom_jitter(size=0.3, width=0.2, color="grey60") + theme_bw() + xlab('Upper Extremity') + ylab('log10(hand rotation acceleration*)') + theme_bw(base_size = 15)
p
ggsave("Figs_N_Tables/NeuroQoL_vs_TremorF1.jpeg", plot = p, width = 5, height = 5, dpi = 150)
ggsave("Figs_N_Tables/NeuroQoL_vs_TremorF1.tiff", plot = p, width = 5, height = 5, dpi = 150)
