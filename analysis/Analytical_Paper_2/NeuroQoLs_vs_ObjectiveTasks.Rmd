...
ggplot(data=df, aes(x=class, y=log10(value))) + geom_boxplot(width=0.7) + geom_jitter(size=0.3, width=0.3, color="grey60") + theme_bw() + xlab('NeuroQoL-Cognition') + ylab('log10(maxTapInterval)') + theme_bw(base_size = 15)
 
df  <- tapF_association %>% filter(feature == 'maxTapInter', survey == 'neuroQOL Upper Extremity')
df <- df$data[[1]]
ggplot(data=df, aes(x=class, y=log10(value))) + geom_boxplot(width=0.9) + geom_jitter(size=0.3, width=0.3, color="grey60") + theme_bw() + xlab('NeuroQoL Upper Extremity') + ylab('log10(maxTapInterval)') + theme_bw(base_size = 15)
```
...
ggplot(data=df, aes(x=class, y=log10(value))) + geom_boxplot(width=0.7) + geom_jitter(size=0.3, width=0.3, color="grey60") + theme_bw() + xlab('NeuroQoL Lower Extremity') + ylab('lgo10(P0Y)') + theme_bw(base_size = 15)
...
df <- df$data[[1]]
ggplot(data=df, aes(x=class, y=log10(value))) + geom_boxplot(width=0.5) + geom_jitter(size=0.3, width=0.2, color="grey60") + theme_bw() + xlab('NeuroQoL Cognition') + ylab('log10(sdTime)') + theme_bw(base_size = 15)


df  <- dsstF_association %>% filter(feature == 'avgTime', survey == 'neuroQOL Cognition')
df <- df$data[[1]]
ggplot(data=df, aes(x=class, y=log10(value))) + geom_boxplot(width=0.5) + geom_jitter(size=0.3, width=0.2, color="grey60") + theme_bw() + xlab('NeuroQoL Cognition') + ylab('lgo10(Average time)') + theme_bw(base_size = 15)
