...
knit2synapse::createAndKnitToFolderEntity(file = "./mpower_control_elevateMS.Rmd",
                                 ...
                                 folderName = "elevateMS action tremor test (mpower PD action tremor train)(no scaling)(atleast 3 records)")
```
...
# High frequency filter (atleast 3 records)
...
ggpubr::ggarrange(p2,p1, ncol = 2, nrow = 1)
```
