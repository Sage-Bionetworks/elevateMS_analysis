...
knit2synapse::createAndKnitToFolderEntity(file = "./mpower_control_elevateMS.Rmd",
                                          ...
                                          folderName = "elevateMS action tremor test (mpower PD action tremor train)(no scaling)(atleast 2 records)(1)")
```
...
CODE = Folder(name = 'elevateMS action tremor test (mpower PD action tremor train)(no scaling)(atleast 2 records)(1)', 
              parentId = "syn19120636")
CODE = synStore(CODE)
